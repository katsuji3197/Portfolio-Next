...
export default function CirKitHP() {
  ...
  //画像の数
  const numberOfImages: number = 12;
  ...
  return (
    <main className="min-h-screen bg-cyan-50 dark:bg-slate-500">
      <div className='md:flex justify-start md:px-24 lg:px-40 xl:px-[300px] pt-64 pb-16'>
        ...
        <Image src='/hpcatch.png' alt='丸い自画像' height={300} width={300} className='drop-shadow-xl items-center p-5'/>
        <div>
          <div className='flex-col text-center justify-center items-center g:text-start text-base md:text-lg pl-5 text-gray-800 w-full'>
            ...
            <div className='pt-2 dark:text-gray-100 pb-12'>また、一部のコンポーネントやページのコーディングも担当しました。</div>
            <div className='flex justify-center'>
              <ContactDisplay href='https://www.cirkit.jp' id="cirkit.jp" title='作成したホームページ'>
      ...
      <div className='flex-col justify-center text-center bg-white dark:bg-gray-600 dark:bg-opacity-60 bg-opacity-60 pt-6 pb-12 w-full shadow-xl'>
          ...
          <div className='sm:px-24 xl:px-64 py-16'>
            <div className='flex flex-wrap flex-col justify-center items-center lg:flex-row gap-12 lg:gap-16 xl:gap-32 md:gap-32 px-16 pt-8 w-full pb-8 md:grid-cols-3 duration-200'>
            {images.map((imageNumber) => (
              <Image
                key={imageNumber}
                src={`/hp_ui/${imageNumber}.png`} // 画像のパスに注意してください。必要に応じてパスを調整してください。
