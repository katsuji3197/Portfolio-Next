...
export default function minshoku() {
  ...
  return (
    <main className="min-h-screen bg-cyan-50 dark:bg-slate-500">
      <div className='md:flex justify-start md:px-24 lg:px-40 xl:px-[300px] pt-64 pb-16'>
        <SectionTitle title='nono1 みんなの食堂'>nono1 みんなの食堂さんのホームページ</SectionTitle>
      </div>
        <div className='flex flex-wrap flex-col justify-center items-center lg:flex-row gap-6 md:gap-24 px-10 pt-5 w-full pb-12 lg:p-7'>
        ...
        <div>
          ...
          <div className=' items-center pt-4 rounded-2xl my-5'>
            ...
            <div className='pt-2 dark:text-gray-100 pb-12'>デザインを作成、そしてコーディングを行いました。</div>
            <div className='flex justify-center'>
              <ContactDisplay href='https://nono1-minshoku.org' id="nono1-minshoku.org" title='作成したホームページ'>
      ...
      <div className='flex-col justify-center text-center bg-white dark:bg-gray-600 dark:bg-opacity-60 bg-opacity-60 pt-6 pb-12 w-full shadow-xl'>
          ...
          <div className='sm:px-24 xl:px-64 py-16'>
            <div className='flex flex-wrap flex-col justify-center items-center lg:flex-row gap-12 lg:gap-16 xl:gap-24 md:gap-32 px-16 pt-8 w-full pb-8 md:grid-cols-3 duration-200'>
            {images.map((imageNumber) => (
              <Image
                key={imageNumber}
                src={`/minshoku/${imageNumber}.png`} // 画像のパスに注意してください。必要に応じてパスを調整してください。
